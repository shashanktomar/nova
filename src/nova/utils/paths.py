...
def get_project_root_from_dirs(start_dir: Path | None, directories: AppDirectories) -> Path | None:
...
def resolve_project_dir_from_dirs(project_root: Path | None, directories: AppDirectories) -> Path | None:
